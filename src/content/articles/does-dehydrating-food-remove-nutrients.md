---
title: "Does Dehydrating Food Remove Nutrients?"
description: "Dehydrating food does remove some nutrients, mainly vitamin C and thiamine, but minerals and protein stay intact. Here is how much each nutrient loses."
keyword: "does dehydrating food remove nutrients"
...
The table below shows typical nutrient retention after a full home drying session at NCHFP-recommended temperatures, without pre-treatment. Retention figures reflect published food science data on air-drying losses ([USDA National Center for Home Food Preservation, Drying Foods](https://nchfp.uga.edu/how/dry/drying_foods.html)).

| Nutrient | Approximate Retention | Notes |
|---|---|---|
| Vitamin C | 50-80% | Most vulnerable; oxidizes with heat and air exposure |
...
| Vitamin K | 85-95% | Fat-soluble; stable at standard drying temps |
...
| Protein | 90-100% | Minor surface denaturation possible; remains bioavailable |
...
The NIH Office of Dietary Supplements identifies ascorbic acid as among the least stable vitamins under heat and oxidation conditions ([NIH ODS Vitamin C Fact Sheet](https://ods.od.nih.gov/factsheets/VitaminC-HealthProfessional/)). Losses during air drying run from about 20% on the low end (short session, lower temperature, less surface area) to 50% or more on the high end (long session, higher temperature, thinly sliced produce with maximum air exposure).
